...
function createArticles() {
  var articles = dataArray.map(function (article, i) {
    ...
    return "\n          <article>\n            <h3>".concat(article.webTitle, "</h3>\n            <div>\n              <span>").concat(article.sectionName, "</span>\n              <time>| ").concat(date(), "</time>\n            </div>\n            <a href=\"").concat(article.webUrl, "\" target=\"_blank\">Show more</a>\n          </article>\n        ");
  }).join("");
...
function _createItems() {
  _createItems = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
